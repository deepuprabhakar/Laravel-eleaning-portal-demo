      ...
      @else
        <div class="box box-success box-solid">
          ...
          <div class="box-body">
            ...
            <table id="articles-table" class="table table-bordered table-hover display dt-responsive nowrap" width="100%" cellspacing="0">
              <thead>
                <tr>
...
@section('script')
    ...
    {!! Html::script('dist/js/custom/listArticles.js') !!}
@stop