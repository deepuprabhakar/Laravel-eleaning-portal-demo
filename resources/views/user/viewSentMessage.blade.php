...
<div class="content-wrapper">
  ...
  <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="{{ route('messages.sent') }}"> Messages</a></li>
          ...
          <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                ...
                @endif
                <li class="active"><a href="{{ route('messages.sent') }}"><i class="fa fa-envelope-o"></i> Sent</a></li>
              </ul>
            </div>
            <!-- /.box-body -->
          </div>
        ...
        <div class="col-md-9">
          <div class="box box-primary">
            ...
            <div class="box-body no-padding">
              ...
              <!-- /.mailbox-read-info -->
              {!! Form::open(['route' => ['messages.destroySent', $messages['hashid']], 'method' => 'DELETE', 'class' => 'message-destroy-form']) !!}
