        ...
        <div class="col-md-9">
          <div class="box box-primary">
            ...
            <div class="box-body no-padding">
              ...
              <!-- /.mailbox-read-info -->
              {!! Form::open(['route' => ['admin.messages.destroy', $messages['hashid']], 'method' => 'DELETE', 'class' => 'message-destroy-form']) !!}
          ...
          <!--reply form -->
            {!! Form::open(['url' => route('admin.messages.reply'), 'autocomplete' => 'off', 'id' => 'reply-form', 'style' => 'display:none']) !!}
