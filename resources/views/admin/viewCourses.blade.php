...
@section('meta')
    ...
    <title>Coheart E-learning - List of Courses</title>
@stop
            ...
            <table id="course-table" class="table table-bordered table-hover display dt-responsive nowrap" width="100%" cellspacing="0">
              <thead>
                <tr>
                  ...
                  <th>Title</th>
                  <th style="width: 100px;" class="text-center">No. of semesters</th>
              ...
              @foreach ($courses as $key => $course)
                <tr>
                  ...
                  <td class="text-center table-actions">
                    <a class="btn bg-purple btn-xs btn-flat" href="{{ route('admin.courses.show', $course->slug) }}">View</a>
                    <a class="btn bg-olive btn-xs btn-flat" href="{{ route('admin.courses.edit', $course->slug) }}" style="margin: 0 3px 0 2px;">Edit</a>
                    {!! Form::open(['route' => ['admin.courses.destroy', $course->hash], 'method' => 'DELETE', 'class' => 'delete-form']) !!}
...
@section('script')
    ...
    {!! Html::script('dist/js/custom/courses.js') !!}
@stop