      ...
      <div class="col-md-12">
        <div class="box box-success box-solid">
          <div class="box-header with-border">
            ...
            <table id="progress-table" class="table table-bordered table-hover display dt-responsive nowrap" width="100%" cellspacing="0">
              <thead>
                <tr>
                  <th style="width: 20px;">No.</th>
                  <th>Student Name</th>
                  <th class="text-center">Discussion Prompt</th>
